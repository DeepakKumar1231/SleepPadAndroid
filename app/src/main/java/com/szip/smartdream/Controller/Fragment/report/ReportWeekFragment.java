...
public class ReportWeekFragment extends BaseFragment {
     ...
     */
    public static ReportWeekFragment newInstance(String param) {
        Bundle bundle = new Bundle();
        bundle.putString("param", param);
        ReportWeekFragment fragment = new ReportWeekFragment();
    ...
    private void initView() {
        ...
        mLineCharforHeart.setXvelue(7,7);
        ...
        mLineCharforBreath.setXvelue(7,7);
...
//
        ...
        mLineCharforThird.setLinePointRadio((int)mLineCharforBreath.getLineWidth());
    ...
    private void getDrawData() {
        ...
        List<HeartInDayData> heartInDayDataList = LoadDataUtil.newInstance().loadHeartListInWeek(mondayDate);
        List<BreathInDayData> breathInDayDataList = LoadDataUtil.newInstance().loadBreathListInWeek(mondayDate);
        List<TurnOverInDayData> turnOverInDayDataList = LoadDataUtil.newInstance().loadTurnOverListInWeek(mondayDate);
